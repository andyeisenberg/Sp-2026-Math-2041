...
},
{
  ...
  "body": " Recommended Homework Problems   It is recommended that you do all of the following problems in order to internalize and practice the concepts that we learn during lectures. You will submit your work on Canvas in the Assignments tab.  The due dates are typically set well after we've covered all relevant sections for each assignment, in order to be flexible with students' schedules. However, the problems will be most useful if you read them before we cover the relevant section and attempt them right after we cover the section.  You are allowed (encouraged!) to discuss these problems with other students and work together. However, each student should write up their own solutions to submit.    Chapter 0: Introduction to Differential Equations     Section 0.2  4 6, 7, 101 103, 106       Chapter 1: First Order Equations     Section 1.2  1 3, 6, 101 104    Section 1.3  1 10, 101 105, 107    Section 1.4  1 (note: on page 41, not with the other exercises), 4 7, 101, 102, 104    Section 1.6  1 (page 53), 3, 5, 7, 101 103    Section 1.8  2, 4, 101, 13       Chapter 2: Higher Order Linear ODEs     Section 2.1  2, 5, 101, 102, 104, 105    Section 2.2  6 12, 101 107    Section 2.4  2, 3, 101, 104    Section 2.5  2 4, 7, 9, 101 104       Chapter 6: The Laplace Transform     Section 6.1  1 (page 295), 4 (page 298), 5 7, 7 11, 101 104    Section 6.2  2 6, 102    Section 6.3  1, 2, 101 103    Section 6.4  1, 2, 101, 102       Chapter 3: Systems of ODEs     Section 3.2  3, 7, 11, 101 103    Section 3.3  1, 2, 101, 102    Section 3.4  5, 7, 102 104    Section 3.5  1, 101, 102    Section 3.7  2, 3, 101, 102, 104    Section 3.9  4, 5, 101, 102 (just use undetermined coefficients for all of these)      "
}
]
